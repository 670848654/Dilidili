package anime.project.dilidili.database;
...
public class DatabaseUtil {
    ...
    public static String DB_PATH = Environment.getExternalStorageDirectory() + "/DiliDiliAnime/Database/dilidili.db";
    ...
    private static boolean checkIndex(String fid, String url){
        String Query = "select * from f_index where f_pid =? and f_url like ?";
    ...
    public static List<AnimeListBean> queryAllFavorite() {
        ...
        while (c.moveToNext()) {
            ...
            bean.setPlay_count(c.getString(7));
